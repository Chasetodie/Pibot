// Instalar: npm install express sqlite3
    ...
    <body>
        <div class="container">
            ...
            <div class="section">
                ...
                <textarea id="sqlQuery" placeholder="SELECT * FROM usuarios;" style="width: 100%; height: 100px; background: #40444b; color: white; border: 1px solid #555; padding: 10px;"></textarea>
                <br>
...
// Iniciar servidor
app.listen(port, () => {
    console.log(`🌐 Panel de administración disponible en puerto ${port}`);
});
